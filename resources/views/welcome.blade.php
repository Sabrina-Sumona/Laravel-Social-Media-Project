                ...
                <div class="row">
                    <div class="row justify-content-end" >
                      <div class=" col-sm-5" id="intro">
                        ...
                        <br>
                        <br>
                        <h3>FaceDiary helps you connect and share with the people in your life.</h3>
                        <br>
                            ...
                            <div class="signup-form">
                                ...
                                <form action="{{route('saveRegister')}}" method="POST">
                                    ...
                                    <div class="form-group" style="text-align: center">
                                        <small class="text-mute">By clicking Create Account, you agree to our Terms and Policy.</small>
                                    </div>
